...
## "들어봤니 모현의 숲🏞" 은 
- 한국외대 글로범 캠퍼스를 배경으로 한 재미있는 동물 테스트입니다.
...
- 각종 SNS를 통해 공유 + CTA 링크를 통해 외대 메타버스 플랫폼으로 초대합니다.

### 기대 효과
- 외대 글로벌캠퍼스의 장점을 부각시켜 학교 생활의 만족도를 높이고자 합니다.
- 글로벌 캠퍼스 위치의 약점을 강점으로 승화시키고자 합니다. 
- 외대 글로벌 캠퍼스생만들의 온라인 커뮤니티를 형성하고자 합니다. 


### 팀프로젝트 참여 & 기여자

|고도희|김재우|김희원|서지오|이준서|정채빈|김다은 
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| Team Lead, PM | UIUX, Developer | Developer | Developer | UIUX, Planning | Developer | Character Designer 
|서비스를 설계하는 개발자가 되고 싶은 고도희입니다.| 풀스택 개발자가 되고 싶은 김재우입니다. |인공지능에 관심 있는 백엔드 개발자 김희원입니다.| 금융관련 백엔드 개발자가 되고 싶은 서지오입니다. | 인생을 기획하는 준서입니다! | Interactive Developer가 되고싶은 정채빈입니다.| 어떤 디자이너가 되고 싶은.. |
