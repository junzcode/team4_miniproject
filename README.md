...
|서비스를 설계하는 개발자가 되고 싶은 고도희입니다. | 어떤 디자이너가 되고 싶은.. | 풀스택 개발자가 되고 싶은 김재우입니다. |인공지능에 관심 있는 백엔드 개발자 김희원입니다.| 금융관련 백엔드 개발자가 되고 싶은 서지오입니다. | 삶을 이롭게하는 기획자가 되고 싶은 준서입니다! | Interactive Developer가 되고싶은 정채빈입니다.|
